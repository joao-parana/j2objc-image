...
//  source: /Users/admin/Desktop/Development/j2objc-image/smoke-test/target/classes/gson/com/google/gson/reflect/TypeToken.java
//
...
void ComGoogleGsonReflectTypeToken_init(ComGoogleGsonReflectTypeToken *self) {
  NSObject_init(self);
  self->type_ = ComGoogleGsonReflectTypeToken_getSuperclassTypeParameterWithIOSClass_([self java_getClass]);
